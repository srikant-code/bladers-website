  ...
  return (
    <Flex>
      <div
        ...
        <p>
          At Bladers Online Multiplayer Spinning Tops, accessible from
          bladers.vercel.app, one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information
          that is collected and recorded by Bladers Online Multiplayer Spinning
          Tops and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Bladers Online Multiplayer Spinning Tops.
        ...
        <p>
          Bladers Online Multiplayer Spinning Tops follows a standard procedure
        ...
        <p>
          ...
          advertising partners of Bladers Online Multiplayer Spinning Tops.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Bladers Online Multiplayer
          Spinning Tops, which are sent directly to users' browser. They
        ...
        <p>
          Note that Bladers Online Multiplayer Spinning Tops has no access to or
        ...
        <p>
          Bladers Online Multiplayer Spinning Tops's Privacy Policy does not
        ...
        <p>
          Bladers Online Multiplayer Spinning Tops does not knowingly collect
